...
enum WARN_CODE_TYPE
{
  ...
  */
    WARN_INVALID_VIEW = 8,
    /** 16: Failed to initialize the video function.
    */
    WARN_INIT_VIDEO = 16,
...
enum ERROR_CODE_TYPE
{
  ...
  */
    ...
    */
    ...
    /** 3: The SDK module is not ready. For example, if some API relies on a specific module, and the module is not ready.
    */
    ERR_NOT_READY = 3,
    /** 4: The SDK does not support this function.
    */
    ERR_NOT_SUPPORTED = 4,
    /** 5: The request is rejected. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_REFUSED = 5,
    ...
    */
    ...
    /** 9: No permission. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_NO_PERMISSION = 9,
    ...
    */
    ERR_TIMEDOUT = 10,
    /** 11: The request is cancelled. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_CANCELED = 11,
    /** 12: The call frequency is too high. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_TOO_OFTEN = 12,
    /** 13: The SDK failed to bind to the network socket. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_BIND_SOCKET = 13,
    /** 14: The network is unavailable. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_NET_DOWN = 14,
    /** 15: No network buffers available. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_NET_NOBUFS = 15,
    /** 17: The request to join the channel is rejected. This error usually occurs when the user is already in the channel, and still calls the API to join the channel, for example, agora::rtc::IRtcEngine::joinChannel.
    */
    ERR_JOIN_CHANNEL_REJECTED = 17,
    /** 18: The request to leave the channel is rejected. This error usually occurs when the user has already left the channel, and still calls the API to leave the channel, for example, agora::rtc::IRtcEngine::leaveChannel.
        */
    ERR_LEAVE_CHANNEL_REJECTED = 18,
    /** 19: Resources have been occupied and cannot be reused.
    */
    ERR_ALREADY_IN_USE = 19,
    /** 20: The SDK gave up the request due to too many requests. This is for internal SDK internal use only, and it will not return to the application through any API or callback event.
    */
    ERR_ABORTED = 20,
    ...
    */
    ...
    /** 102: The specified Token is invalid.
    */
...
- Call Expiration Timestamp expired: The timestamp indicates the exact time when a user can no longer use the Agora service (for example, when a user is forced to leave an ongoing call). When the value is set for the Call Expiration Timestamp, it does not mean that the Token will be expired, but that the user will be kicked out of the channel.
    */
    ...
    - The App Certificate for the project is enabled on the Dashboard, but the user is still using the App ID. Once the App Certificate is enabled, the user must use a Token.
    - The uid field is mandatory, and users must set the same uid when setting the uid parameter when calling agora::rtc::IRtcEngine::joinChannel.
    */
