...
import com.iolink.test.samplepost.WhatsappActivity;
...
public class TabFragment2 extends Fragment implements RecyclerViewAdapter.ItemListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        arrayList.add(new DataModel("Camera", R.drawable.camera, "#FFAEB9"));
        arrayList.add(new DataModel("Gallery", R.drawable.gallery, "#DEB887"));
        arrayList.add(new DataModel("Music", R.drawable.music, "#DDA0DD"));
        arrayList.add(new DataModel("Whatsapp", R.drawable.whatsapp, "#00BFFF"));
    ...
    private void handleShakeEvent(int count) {
        //t1.speak("Camera,Gallery,Music,Whatsapp", TextToSpeech.QUEUE_FLUSH, null);
    }
