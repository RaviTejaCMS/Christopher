...
public class Page2Activity extends AppCompatActivity implements RecyclerViewAdapter.ItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new DataModel("Call", R.drawable.call, "#008080"));
        arrayList.add(new DataModel("Message", R.drawable.message, "#808000"));
        arrayList.add(new DataModel("Contact", R.drawable.contact, "#800000"));
        arrayList.add(new DataModel("Time", R.drawable.time, "#ffe119"));

        arrayList.add(new DataModel("Music", R.drawable.music, "#008080"));
        arrayList.add(new DataModel("Settings", R.drawable.settings, "#808000"));
        arrayList.add(new DataModel("Camera", R.drawable.camera, "#800000"));
        arrayList.add(new DataModel("Gallery", R.drawable.gallery, "#ffe119"));

        arrayList.add(new DataModel("Internet", R.drawable.internet, "#808080"));
        arrayList.add(new DataModel("Whatsapp", R.drawable.whatsapp, "#3cb44b"));
        arrayList.add(new DataModel("Store", R.drawable.store, "#673BB7"));
        arrayList.add(new DataModel("Help", R.drawable.help, "#aa6e28"));
